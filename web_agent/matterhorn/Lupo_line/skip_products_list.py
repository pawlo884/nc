...
SKIP_PRODUCT_IDS = [
    ...
    # duplikat: Wystąpił błąd podczas tworzenia produktu MPD: duplicate key value violates unique constraint "colors...
    167184,
    211566,  # duplikat: Wystąpił błąd podczas tworzenia produktu MPD: duplicate key value violates unique constraint "colors...
    211565,  # duplikat: Wystąpił błąd podczas tworzenia produktu MPD: duplicate key value violates unique constraint "colors...
]
