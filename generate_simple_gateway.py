#!/usr/bin/env python
"""
Skrypt do generowania uproszczonego gateway.xml z tylko głównymi endpointami
"""
...
def generate_simple_gateway():
    """Generuje uproszczony gateway.xml z tylko głównymi endpointami"""
    print("🌐 Generowanie uproszczonego gateway.xml...")
    ...
    try:
        ...
        print(f"✅ Uproszczony gateway.xml wygenerowany pomyślnie!")
        ...
        # Sprawdź URL-e
        print("\n🌐 Sprawdzanie URL-i:")
        if api_url in xml_content:
            print("✅ URL-e używają poprawnej domeny")
        else:
...
if __name__ == "__main__":
    success = generate_simple_gateway()
    if success:
