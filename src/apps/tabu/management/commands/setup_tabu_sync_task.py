"""
Konfiguruje periodic task dla synchronizacji produktów Tabu (co 10 minut).
Użycie:
...
class Command(BaseCommand):
    help = 'Konfiguruje periodic task dla synchronizacji produktów Tabu (co 10 minut)'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            PeriodicTask.objects.create(
                ...
                description='Synchronizuje produkty Tabu z API (update_from)',
            )
        ...
        self.stdout.write(
            self.style.HTTP_INFO(
                ...
                '   - Zmiana interwału: python manage.py setup_tabu_sync_task --interval 10\n'
